...
if __name__ == "__main__":
    ...
    class MockVendor:
        ...
        mcc = "5411"  # Grocery store MCC
        currency_code = "404"  # KES
        country_code = "KE"
        store_label = "Nairobi"
    
    vendor = MockVendor()
    qr_gen = QR_utils(vendor)
    
    print("=" * 60)
    print("🧪 Testing QR Code Generation")
    print("=" * 60)
    
    # Test 1: Merchant QR (no amount)
    print("\n1️⃣  Merchant QR (Dynamic - Customer enters amount):")
    img, payload = qr_gen.generate_merchant_qr()
    print(f"   📦 Payload: {payload}")
    img.save("test_merchant_qr.png")
    print("   ✅ Saved as test_merchant_qr.png")
    
    # Test 2: Fixed Amount QR
    print("\n2️⃣  Fixed Amount QR (Static - KES 500):")
    img, payload = qr_gen.generate_fixed_amount_qr(amount=500)
    print(f"   📦 Payload: {payload}")
    img.save("test_fixed_qr.png")
    print("   ✅ Saved as test_fixed_qr.png")
    
    # Test 3: Transaction QR without reference
    print("\n3️⃣  Transaction QR (No reference - KES 1250):")
    img, payload = qr_gen.generate_transaction_qr(amount=1250)
    print(f"   📦 Payload: {payload}")
    img.save("test_transaction_no_ref_qr.png")
    print("   ✅ Saved as test_transaction_no_ref_qr.png")
    
    # Test 4: Transaction QR with reference (POS)
    print("\n4️⃣  Transaction QR (POS - KES 1250, Ref: TXN20251018001):")
    img, payload = qr_gen.generate_transaction_qr(
        amount=1250,
        reference_number="TXN20251018001"
    )
    print(f"   📦 Payload: {payload}")
    img.save("test_transaction_qr.png")
    print("   ✅ Saved as test_transaction_qr.png")
    
    print("\n" + "=" * 60)
    print("✅ All tests completed successfully! 🎉")
    print("=" * 60)
    print("\n💡 Check your backend folder for the generated QR code images!")